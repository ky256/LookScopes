...
content = r"""# UE 视口分析与 Look Match 插件设计开发白皮书
...
pathlib.Path(r'I:/Aura/Plugins/LookScopes/Docs/DesignDoc.md').write_text(content, encoding='utf-8')
print('DesignDoc.md written successfully!')