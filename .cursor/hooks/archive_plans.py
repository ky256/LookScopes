...
扫描 Cursor 全局 plans 目录，将属于 MetaAgent 项目的 plan 归档到 docs/plans/。
作为 sessionEnd hook 的兜底机制，补充 Cursor Rule 可能遗漏的归档。

用法:
    py -3 .cursor/hooks/archive_plans.py [--project-dir PATH] [--dry-run]
"""
